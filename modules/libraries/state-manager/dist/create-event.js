...
function sanitizePayload(payload, payloadShape) {
    ...
    return Object.fromEntries(Object.entries(payloadShape).map(([key]) => [key, payload[key]]));
}
export const createEvent = ({ payloadShape, eventType, isNewCycle }, componentPath, payload) => {
