...
describe("create reducers", () => {
    test("create own reducer", () => {
        ...
        const event = {eventType: 'eventOneOccurred', payload: {key2: 'value2'}, componentPath: []};
    ...
    test("create child reducer", () => {
        ...
        const event = {eventType: 'eventOneOccurred', payload: {key2: 'value2'}, componentPath: ["child1"]};

        //when
        const actual = componentReducer(component)(state, event);

        //then
        expect(actual).toEqual({children: {child1: {ownState: {key1: 'value1', key2: 'value2'}}}});
    });
