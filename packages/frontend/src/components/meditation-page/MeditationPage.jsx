...
import {GlobalStateContext} from "../global-state/GlobalStateContext.jsx";
import {
    gongVolumeSet,
...
function MeditationPage() {
    ...
    const meditationTimerState = () => appSelectors.getMeditationTimerState(state);
    const preparationTimerState = () => appSelectors.getPreparationTimerState(state);

    return <>
        <Timer timerState={meditationTimerState()}></Timer>
        <div className={'subtle'}>
            <p>{t("preparation")}</p>
            <Timer timerState={preparationTimerState()} ></Timer>
        </div>
